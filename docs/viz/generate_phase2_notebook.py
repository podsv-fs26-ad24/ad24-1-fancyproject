...
CODE_SETUP = r'''from pathlib import Path
import numpy as np
import pandas as pd
...
CODE_MAIN = r'''import numpy as np
import pandas as pd
...
def _code_main_for_quarto_site() -> str:
    """Same as notebook cell but no output_notebook; return layout for Quarto ``show()``."""
    q = CODE_MAIN.replace(
        "from bokeh.plotting import figure, output_notebook, show\n",
